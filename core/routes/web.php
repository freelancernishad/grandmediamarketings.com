...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin', 'demo'])->group(function () {
        ...
        Route::resource('user-designations', UserDesignationController::class);
// Add this route to handle the request to view users with a specific designation
        Route::get('designations/{id}/users', [DesignationController::class, 'showUsers'])->name('designations.users');
...
Route::name('user.')->group(function () {
    ...
    Route::middleware(['auth', 'inactive', 'is_email_verified'])->group(function () {
        ...
        Route::middleware('2fa','kyc')->group(function () {
            ...
            Route::get('paypal', [ProcessController::class, 'ipn'])->name('paypal');
