<?php $__env->startSection('content'); ?>
    ...
    <section class="auth-section">
        ...
        <div class="auth-thumb-area" style="background-image: url('<?php echo e(getFile('frontendlogin', @$general->frontend_login_image)); ?>')">
        </div>
    </section>
...
<?php echo $__env->make(template().'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\divine_beta_trade\core\resources\views/theme5/user/auth/login.blade.php ENDPATH**/ ?>