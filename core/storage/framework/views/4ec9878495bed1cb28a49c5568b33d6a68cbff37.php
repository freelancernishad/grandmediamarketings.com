                                    ...
                                    <tr>
                                        <td>
                                            <h5>
                                                ...
                                                <?php echo e(__('Universe Theme')); ?>

                                            </h5>
                                            <p>
                                                <a data-route="<?php echo e(route('admin.manage.theme.update', 5)); ?>"
                                                    class="<?php if($general->theme != 5): ?> btn btn-outline-danger btn-sm active-btn <?php endif; ?> <?php if($general->theme == 5): ?> text-success <?php else: ?> text-danger <?php endif; ?> font-weight-bolder">
                                                    <?php if($general->theme == 5): ?>
                                                        <?php echo e(__('Activated')); ?>
                                        ...
                                        <td><?php echo e(__('Universe Theme')); ?></td>
                                        <td>
                                            <button data-href="https://hyipmaxthree.springsoftit.com/"
                                                class="btn btn-primary btn-sm prev">
                                                <?php echo e(__('Preview')); ?>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/divinebetatrade/public_html/core/resources/views/backend/setting/theme.blade.php ENDPATH**/ ?>