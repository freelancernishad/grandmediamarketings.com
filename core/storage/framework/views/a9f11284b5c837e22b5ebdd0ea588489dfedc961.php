<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown <?php echo e(menuActive('admin.designations*')); ?>">
                <a href="<?php echo e(route('admin.designations.index')); ?>" class="nav-link ">
                    <i data-feather="link"></i>
                    <span><?php echo e(__('Designations')); ?></span>
                </a>
            </li>
...
<?php /**PATH C:\xampp\htdocs\divine_beta_trade\core\resources\views/backend/layout/sidebar.blade.php ENDPATH**/ ?>