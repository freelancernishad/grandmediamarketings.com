                ...
                <div class="row gy-4 mobile-box-wrapper">
                    ...
                    <div class="col-3">
                        <div class="mobile-box link-item">
                            ...
                            <img src="{{ asset('asset/theme5/images/d-icon/2.png') }}" alt="icon">
                    ...
                    <div class="col-3">
                        <div class="mobile-box link-item">
                            ...
                            <img src="{{ asset('asset/theme5/images/d-icon/3.png') }}" alt="icon">
                    ...
                    <div class="col-3">
                        <div class="mobile-box link-item">
                            ...
                            <img src="{{ asset('asset/theme5/images/d-icon/4.png') }}" alt="icon">
