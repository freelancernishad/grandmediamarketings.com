                                ...
                                <thead>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p>
                                                <a data-route="{{ route('admin.manage.theme.update', 5) }}"
                                                    class="@if ($general->theme != 5) btn btn-outline-danger btn-sm active-btn @endif @if ($general->theme == 5) text-success @else text-danger @endif font-weight-bolder">
                                                    @if ($general->theme == 5)
                                                        {{__('Activated')}}
                                                    @else
                                                        {{__('Active')}}
